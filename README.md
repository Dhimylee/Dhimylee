...
Degree in Systems Analysis and Development (SENAC), Tech Degree in IT (ETC), and Postgraduate in UX Design (SENAC).
Passionate about web development, I combine technical skills with user experience concepts to build modern, intuitive, and high-performance interfaces.

🚀 Current Stack:

- Frameworks & Libs: React, Next.js
- Languages & Web: JavaScript, TypeScript, PHP, Node.js, HTML5, CSS3/SASS
...
- <img src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Objects/Laptop.png" alt="Laptop" width="25" height="25" /> TypeScript and PHP, Node.js are some of the technologies on my radar.
